  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        easing: "ease-in",
        easingCurve: "cubic-bezier(0.32, 0.06, 0.73, 0.15)",
        duration: "4s (2s delay + 2s ramp)",
        category: "intros",
        tags: ["ease-out", "opacity", "enter"],
        useCase: "Image intros, onboarding visuals, cinematic dissolve transitions",
      },
      {
      ...
      {
        id: "intro-convo-screen",
        name: "Convo Screen",
        description:
          "A sequenced entrance animation for a conversational screen. Navigation and prompt bar fade in first, response chips stagger upward with spring physics, then the headline and care team badge ease into view.",
        easing: "ease-out",
        easingCurve: "cubic-bezier(0, 0, 0.58, 1)",
        duration: "350ms + stagger",
        category: "intros",
        tags: ["ease-out", "opacity", "enter", "stagger"],
        useCase: "Conversational intros, onboarding screens, guided response flows",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: "card-3d-glass-2",
        name: "Card 3D Glass 2",
        description:
          "Edge-weighted glass distortion variant. Same card expand with heavier chromatic aberration and edge displacement that warps the card boundaries outward while the center stays stable.",
        easing: "spring",
        easingCurve: "cubic-bezier(0.32, 1.12, 0.48, 1)",
        duration: "500ms",
        category: "cards",
    ...
    items: [
      {
        ...
        swiftFile: "menu-expand/MenuExpandView.swift",
        swiftPackage: {
          folder: "menu-expand",
          exportName: "MenuExpand",
          files: [
            "MenuExpandView.swift",
            "SubComponents.swift",
            "Icons.swift",
            "PhoneFrame.swift",
            "Color+Hex.swift",
      ...
      },
      {
        ...
        swiftFile: "nav-page-transition/NavPageTransitionView.swift",
        swiftPackage: {
          folder: "nav-page-transition",
          exportName: "NavPageTransition",
          files: [
            "NavPageTransitionView.swift",
            "SubComponents.swift",
            "Icons.swift",
            "PhoneFrame.swift",
            "Color+Hex.swift",
      ...
      },
      {
        ...
        tags: ["spring", "slide", "enter", "exit", "state-change"],
        useCase: "Tab-driven page switching, dashboard navigation, multi-view apps",
        swiftFile: "nav-page-transition-3/NavPageTransition3View.swift",
        swiftPackage: {
          folder: "nav-page-transition-3",
          exportName: "NavPageTransition3",
          files: [
            "NavPageTransition3View.swift",
            "SubComponents.swift",
            "Icons.swift",
            "PhoneFrame.swift",
            "Color+Hex.swift",

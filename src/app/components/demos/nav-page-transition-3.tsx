...
const pillSpring = { type: "spring" as const, stiffness: 200, damping: 25 };
...
function PromptBar() {
  return (
    <motion.div
      initial={{ x: 200 }}
      animate={{ x: 0, transition: { duration: exitDuration, ease: easeInOutCubic } }}
      exit={{ x: -200, transition: { duration: exitDuration, ease: easeOutQuad } }}
